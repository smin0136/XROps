...
public class Legend : MonoBehaviour {
    ...
    {
        GameObject legendValuePrefab = Resources.Load("Legend/LegendValue 1", typeof(GameObject)) as GameObject;
        if (channelEncoding.channel == "color")
        {
            ...
            //gameObject.GetComponent<Microsoft.MixedReality.Toolkit.Utilities.BaseObjectCollection>();
            ...
            gameObject.GetComponent<Microsoft.MixedReality.Toolkit.Utilities.GridObjectCollection>().UpdateCollection();
            //Debug.Log("legendValue gameob position " + legendValueInstance.transform.position.ToString());
