...
namespace DxR
{
    public class Axis : MonoBehaviour
    {
        ...
        {
            Transform slider = gameObject.transform.Find("AxisLine/ThresholdFilter");
            ...
            PinchSlider pinchSlider = slider.GetComponent<PinchSlider>();



            if (pinchSlider == null) return;
            ...
            Transform button_label = slider.Find("SliderThumb/Button_AnimationContainer/Slider_Button/Label");
            ...
            {
                pinchSlider.OnValueUpdated.AddListener(delegate { interactionsObject.ThresholdFilterUpdated(slider.gameObject); }) ;
            }
        }
        ...
        private void SetFilterLength(float length)
        {
            ...
            Transform sliderBar = gameObject.transform.Find("AxisLine/ThresholdFilter");
            Transform axis = gameObject.transform.Find("AxisLine");
            if (sliderBar != null)
            {
                /*
                ...
                Transform knob = gameObject.transform.Find("AxisLine/ThresholdFilter/SliderThumb");

                //float newLocalScale = 0.5f / 0.2127f;
                Debug.Log("length" + length);

                float newLocalScale = 15;
