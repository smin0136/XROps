...
public class AzureSpatialAnchorsScript : MonoBehaviour
{
    ...
    private async Task CreateAnchor(Vector3 position)
    {
        ...
        GameObject visPrefab = Resources.Load("Anchor/DxRVis") as GameObject;
        GameObject VisPref = Instantiate(visPrefab);
        VisPref.transform.position = position;
        VisPref.transform.rotation = orientationTowardsHead;
        //VisPref.transform.localScale = Vector3.one * 0.1f;
       ...
       */
        ...
        CloudNativeAnchor cloudNativeAnchor = VisPref.AddComponent<CloudNativeAnchor>();
        ...
        try
        {
            ...
            _foundOrCreatedAnchorGameObjects.Add(VisPref);
            _createdAnchorIDs.Add(cloudSpatialAnchor.Identifier);
            VisPref.GetComponent<MeshRenderer>().material.color = Color.green;
        }
