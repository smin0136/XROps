...
from yolo.utils.preprocess_utils import align_faces
from yolo.utils.general import check_img_size, non_max_suppression_face, \
...
class YoloDetector:
    ...
    def _preprocess(self,imgs):
        ...
        pp_imgs = np.clip(pp_imgs.astype(np.float32), 0.0, 1000.0) #16bit
        pp_imgs /= 1000 #16bit
