...
# Stream TCP Ports
class StreamPort:
    RM_VLC_LEFTFRONT     = 12000
    RM_VLC_LEFTLEFT      = 12001
    RM_VLC_RIGHTFRONT    = 12002
    RM_VLC_RIGHTRIGHT    = 12003
    RM_DEPTH_AHAT        = 12004
    RM_DEPTH_LONGTHROW   = 12005
    RM_IMU_ACCELEROMETER = 12006
    RM_IMU_GYROSCOPE     = 12007
    RM_IMU_MAGNETOMETER  = 12008
    PERSONAL_VIDEO       = 12010
    MICROPHONE           = 12011
    SPATIAL_INPUT        = 12012
    EXTENDED_EYE_TRACKER = 12017
    EXTENDED_AUDIO       = 12018
...
class _client:
    def open(self, host, port):
        try:
            ...
            conn = None
        self._socket = conn
        self._listen_socket = serverSocket
