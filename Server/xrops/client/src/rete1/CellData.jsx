...
export class CellDataControl extends Rete.Control {
  ...
  static component = ({ value, onChange }) => {
    ...
    async function getFileList(){
      const data = await getCellFilesAPI(workingDir);
...
//      console.log(fileList);
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = CellDataControl.component;
...
export class CellDataComponent extends Rete.Component {
  constructor() {
    super("Cell Plate Data");
    this.node_id =
      Date.now().toString() + (Math.random() + 1).toString(36).substring(7);
  }
  ...
  builder(node) {
    ...
    var ctrl = new CellDataControl(this.editor, "data", node);
