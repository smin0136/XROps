...
export class XRVolumeToPointDataControl extends Rete.Control {
  static component = ({ value, onChange }) => {
    ...
    const handleProcess = async (e) => {
      var path = await XRVolumeToPointDataAPI(value['id'],value['input']);
      console.log(path);
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = XRVolumeToPointDataControl.component;
...
export class XRVolumeToPointDataComponent extends Rete.Component {
  constructor(type) {
    super("Volume to Point Data");
  ...
  builder(node) {
    ...
    var ctrl = new XRVolumeToPointDataControl(this.editor, "data", node);
