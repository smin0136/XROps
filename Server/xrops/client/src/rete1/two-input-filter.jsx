...
export class TwoInputFilterControl extends Rete.Control {
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = TwoInputFilterControl.component;
...
export class TwoInputFilterComponent extends Rete.Component {
  constructor(type) {
    super(`${type}`);
  ...
  builder(node) {
    ...
    var ctrl = new TwoInputFilterControl(this.editor, "image", node);
    node.id =
      Date.now().toString() + (Math.random() + 1).toString(36).substring(7);
