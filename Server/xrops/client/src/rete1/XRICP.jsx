...
import Viewer from "./xr-viewer/point-registration-viewer.component";

export class XRICPControl extends Rete.Control {
  static component = ({ value, onChange }) => {
    ...
    const handleProcess = async (e) => {
      var matrix = await XRICPAPI(value['source_input'],value['target_input']);
      console.log(matrix);
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = XRICPControl.component;
...
export class XRICPComponent extends Rete.Component {
  constructor(type) {
    super("ICP (point registration)");
  ...
  builder(node) {
    ...
    var ctrl = new XRICPControl(this.editor, "data", node);
