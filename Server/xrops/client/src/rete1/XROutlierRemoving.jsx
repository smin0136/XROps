...
export class XROutlierRemovingControl extends Rete.Control {
  static component = ({ value, onChange }) => {
    ...
    const handleProcess = async (e) => {
      var path = await XROutlierRemovingAPI(value['id'],value['input']);
      console.log(path);
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = XROutlierRemovingControl.component;
...
export class XROutlierRemovingComponent extends Rete.Component {
  constructor(type) {
    super("Outlier Removing");
  ...
  builder(node) {
    ...
    var ctrl = new XROutlierRemovingControl(this.editor, "data", node);
