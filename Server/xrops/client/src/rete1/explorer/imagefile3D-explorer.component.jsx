...
const Explorer = (props) => {
  ...
  async function getFileList(){
    const data = await getFilesAPI(dir,'.tif');
      ...
      file_list_html.push(
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
          <div id={fileList[i]} className="file-snapshot selected" onClick={changeFile} 
            style={{backgroundImage: "url("+baseURL+"holoSensor/get_mip//workspace/xrops/users/"+each_path+")"}}></div>
    ...
    >
      ...
      >
        ...
        <div className="right-panel">
          ...
          <div className="preview-panel" style={{backgroundImage: "url("+baseURL+"holoSensor/get_mip//workspace/xrops/users/"+path+")", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "60%"}}> 
          </div>
