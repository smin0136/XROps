...
export class XRWorldPositioningControl extends Rete.Control {
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = XRWorldPositioningControl.component;
...
export class XRWorldPositioningComponent extends Rete.Component {
  constructor(type) {
    super("World Positioning");
  ...
  builder(node) {
    ...
    var ctrl = new XRWorldPositioningControl(this.editor, "data", node);
