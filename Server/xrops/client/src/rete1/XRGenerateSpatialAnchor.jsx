...
export class XRGenerateSpatialAnchorControl extends Rete.Control {
  ...
  constructor(emitter, key, node, readonly = false) {
    ...
    this.key = key;
    this.component = XRGenerateSpatialAnchorControl.component;
...
export class XRGenerateSpatialAnchorComponent extends Rete.Component {
  constructor(type) {
    super("Generate Spatial Anchor");
  ...
  builder(node) {
    ...
    var ctrl = new XRGenerateSpatialAnchorControl(this.editor, "data", node);
