...
ViaWebGL = function(incoming) {
    ...
    this.tile_start_pos = 'u_tile_start_pos';
...
ViaWebGL.prototype = {
    ...
    toBuffers: function(program) {
        ...
        this.pointed_color = gl.getUniformLocation(program, "pointed_color");

        // var tile_start_pos = gl.getUniformLocation(program, this.tile_start_pos);
        // gl.uniform2f(tile_start_pos, gl.canvas.height, gl.canvas.width);
...
//        console.log(tile.pointed_color);
        if(tile.pointed_color){
            gl.uniform3f(this.pointed_color, tile.pointed_color[0]/255.0,tile.pointed_color[1]/255.0,tile.pointed_color[2]/255.0);
        }
